...
struct hwloc_topology {
  ...
  int (*set_membind)(hwloc_topology_t topology, hwloc_const_cpuset_t set, int policy);
  int (*get_membind)(hwloc_topology_t topology, hwloc_cpuset_t set, int * policy);
  int (*set_proc_membind)(hwloc_topology_t topology, hwloc_pid_t pid, hwloc_const_cpuset_t set, int policy);
  int (*get_proc_membind)(hwloc_topology_t topology, hwloc_pid_t pid, hwloc_cpuset_t set, int * policy);
