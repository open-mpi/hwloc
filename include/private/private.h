...
struct topo_topology {
  ...
  int (*set_proc_cpubind)(topo_topology_t topology, hwloc_pid_t pid, const topo_cpuset_t *set, int strict);
#ifdef hwloc_thread_t
  int (*set_thread_cpubind)(topo_topology_t topology, hwloc_thread_t tid, const topo_cpuset_t *set, int strict);
#endif
