...
struct hwloc_topology {
  ...
  int (*get_thisproc_lastcpuexec)(hwloc_topology_t topology, hwloc_cpuset_t set, int flags);
  int (*get_thisthread_lastcpuexec)(hwloc_topology_t topology, hwloc_cpuset_t set, int flags);
  int (*get_proc_lastcpuexec)(hwloc_topology_t topology, hwloc_pid_t pid, hwloc_cpuset_t set, int flags);
