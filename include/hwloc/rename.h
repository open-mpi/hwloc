...
#define hwloc_const_cpuset_t HWLOC_NAME(hwloc_const_cpuset_t)

#define hwloc_cpuset_alloc HWLOC_NAME(hwloc_cpuset_alloc)
#define hwloc_cpuset_free HWLOC_NAME(hwloc_cpuset_free)
#define hwloc_cpuset_dup HWLOC_NAME(hwloc_cpuset_dup)
#define hwloc_cpuset_copy HWLOC_NAME(hwloc_cpuset_copy)
#define hwloc_cpuset_snprintf HWLOC_NAME(hwloc_cpuset_snprintf)
#define hwloc_cpuset_asprintf HWLOC_NAME(hwloc_cpuset_asprintf)
#define hwloc_cpuset_from_string HWLOC_NAME(hwloc_cpuset_from_string)
#define hwloc_cpuset_zero HWLOC_NAME(hwloc_cpuset_zero)
#define hwloc_cpuset_fill HWLOC_NAME(hwloc_cpuset_fill)
#define hwloc_cpuset_from_ulong HWLOC_NAME(hwloc_cpuset_from_ulong)

#define hwloc_cpuset_from_ith_ulong HWLOC_NAME(hwloc_cpuset_from_ith_ulong)
#define hwloc_cpuset_to_ulong HWLOC_NAME(hwloc_cpuset_to_ulong)
#define hwloc_cpuset_to_ith_ulong HWLOC_NAME(hwloc_cpuset_to_ith_ulong)
#define hwloc_cpuset_cpu HWLOC_NAME(hwloc_cpuset_cpu)
#define hwloc_cpuset_all_but_cpu HWLOC_NAME(hwloc_cpuset_all_but_cpu)
#define hwloc_cpuset_set HWLOC_NAME(hwloc_cpuset_set)
#define hwloc_cpuset_set_range HWLOC_NAME(hwloc_cpuset_set_range)
#define hwloc_cpuset_clr HWLOC_NAME(hwloc_cpuset_clr)
#define hwloc_cpuset_clr_range HWLOC_NAME(hwloc_cpuset_clr_range)
#define hwloc_cpuset_isset HWLOC_NAME(hwloc_cpuset_isset)
#define hwloc_cpuset_iszero HWLOC_NAME(hwloc_cpuset_iszero)
#define hwloc_cpuset_isfull HWLOC_NAME(hwloc_cpuset_isfull)
#define hwloc_cpuset_isequal HWLOC_NAME(hwloc_cpuset_isequal)
#define hwloc_cpuset_intersects HWLOC_NAME(hwloc_cpuset_intersects)
#define hwloc_cpuset_isincluded HWLOC_NAME(hwloc_cpuset_isincluded)
#define hwloc_cpuset_orset HWLOC_NAME(hwloc_cpuset_orset)
#define hwloc_cpuset_andset HWLOC_NAME(hwloc_cpuset_andset)
#define hwloc_cpuset_clearset HWLOC_NAME(hwloc_cpuset_clearset)
#define hwloc_cpuset_xorset HWLOC_NAME(hwloc_cpuset_xorset)
#define hwloc_cpuset_notset HWLOC_NAME(hwloc_cpuset_notset)
#define hwloc_cpuset_first HWLOC_NAME(hwloc_cpuset_first)
#define hwloc_cpuset_last HWLOC_NAME(hwloc_cpuset_last)
#define hwloc_cpuset_singlify HWLOC_NAME(hwloc_cpuset_singlify)
#define hwloc_cpuset_compare_first HWLOC_NAME(hwloc_cpuset_compare_first)
#define hwloc_cpuset_compare HWLOC_NAME(hwloc_cpuset_compare)
#define hwloc_cpuset_weight HWLOC_NAME(hwloc_cpuset_weight)

/* hwloc/helper.h */

#define hwloc_get_type_or_below_depth HWLOC_NAME(hwloc_get_type_or_below_depth)
#define hwloc_get_type_or_above_depth HWLOC_NAME(hwloc_get_type_or_above_depth)
#define hwloc_get_system_obj HWLOC_NAME(hwloc_get_system_obj)
#define hwloc_get_parent_obj_by_depth HWLOC_NAME(hwloc_get_parent_obj_by_depth)
#define hwloc_get_parent_obj_by_type HWLOC_NAME(hwloc_get_parent_obj_by_type)
#define hwloc_get_next_obj_by_depth HWLOC_NAME(hwloc_get_next_obj_by_depth)
#define hwloc_get_next_obj_by_type HWLOC_NAME(hwloc_get_next_obj_by_type)
#define hwloc_get_proc_obj_by_os_index HWLOC_NAME(hwloc_get_proc_obj_by_os_index)
#define hwloc_get_next_child HWLOC_NAME(hwloc_get_next_child)
#define hwloc_get_common_ancestor_obj HWLOC_NAME(hwloc_get_common_ancestor_obj)
#define hwloc_obj_is_in_subtree HWLOC_NAME(hwloc_obj_is_in_subtree)

/* glibc-sched.h */

#define hwloc_cpuset_to_glibc_sched_affinity HWLOC_NAME(hwloc_cpuset_to_glibc_sched_affinity)
#define hwloc_cpuset_from_glibc_sched_affinity HWLOC_NAME(hwloc_cpuset_from_glibc_sched_affinity)

/* linux-libnuma.h */

#define hwloc_cpuset_to_linux_libnuma_ulongs HWLOC_NAME(hwloc_cpuset_to_linux_libnuma_ulongs)
#define hwloc_cpuset_from_linux_libnuma_ulongs HWLOC_NAME(hwloc_cpuset_from_linux_libnuma_ulongs)
#define hwloc_cpuset_to_linux_libnuma_bitmask HWLOC_NAME(hwloc_cpuset_to_linux_libnuma_bitmask)
#define hwloc_cpuset_from_linux_libnuma_bitmask HWLOC_NAME(hwloc_cpuset_from_linux_libnuma_bitmask)
#define hwloc_cpuset_to_linux_libnuma_nodemask HWLOC_NAME(hwloc_cpuset_to_linux_libnuma_nodemask)
#define hwloc_cpuset_from_linux_libnuma_nodemask HWLOC_NAME(hwloc_cpuset_from_linux_libnuma_nodemask)

/* linux.h */

#define hwloc_linux_parse_cpumap_file HWLOC_NAME(hwloc_linux_parse_cpumap_file)
#define hwloc_linux_set_tid_cpubind HWLOC_NAME(hwloc_linux_set_tid_cpubind)
#define hwloc_linux_get_tid_cpubind HWLOC_NAME(hwloc_linux_get_tid_cpubind)

/* openfabrics-verbs.h */

#define hwloc_ibv_get_device_cpuset HWLOC_NAME(hwloc_ibv_get_device_cpuset)
